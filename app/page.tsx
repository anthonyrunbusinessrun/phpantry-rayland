        ...
        <div style={{ maxWidth:1200, margin:'0 auto', display:'grid', gridTemplateColumns:'1fr 1fr', gap:80, alignItems:'center' }}>
          ...
          <div className="apple-right" data-delay="120">
            ...
            <div style={{ display:'grid', gridTemplateColumns:'1fr 1fr', gap:14 }}>
              <div style={{ background:'var(--bg-card)', border:'1px solid var(--border)', borderRadius:6, padding:'22px 20px', position:'relative', overflow:'hidden' }}>
                <div style={{ position:'absolute', left:0, top:0, bottom:0, width:3, background:'#0E7490', borderRadius:'6px 0 0 6px' }} />
                <div style={{ fontSize:22, marginBottom:10 }}>🎯</div>
                <div style={{ fontFamily:'var(--font-cond)', fontSize:16, fontWeight:700, color:'var(--text)', marginBottom:8 }}>Our Mission</div>
                <div style={{ fontSize:13, color:'var(--text-muted)', lineHeight:1.75 }}>To make food accessible, consistent, and dignified for every Filipino in need by building community-driven pantries rooted in compassion, faith, and shared responsibility.</div>
              </div>
              <div style={{ background:'var(--bg-card)', border:'1px solid var(--border)', borderRadius:6, padding:'22px 20px', position:'relative', overflow:'hidden' }}>
                <div style={{ position:'absolute', left:0, top:0, bottom:0, width:3, background:'#3B1FA3', borderRadius:'6px 0 0 6px' }} />
                <div style={{ fontSize:22, marginBottom:10 }}>🌟</div>
                <div style={{ fontFamily:'var(--font-cond)', fontSize:16, fontWeight:700, color:'var(--text)', marginBottom:8 }}>Our Vision</div>
                <div style={{ fontSize:13, color:'var(--text-muted)', lineHeight:1.75 }}>A Philippines where no one goes hungry and every community is strengthened through unity, care, and hope.</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <section style={{ padding:'100px 5%', background:'var(--bg-card2)' }}>
        <div style={{ maxWidth:1200, margin:'0 auto' }}>
          <div style={{ textAlign:'center', marginBottom:20 }}>
            ...
            <p style={{ fontSize:16, color:'rgba(255,255,255,0.7)', maxWidth:560, margin:'0 auto 24px', lineHeight:1.8, fontWeight:300 }}>
              At the heart of PHPantry is one simple principle:
            </p>
            <div style={{ display:'inline-block', background:'rgba(14,116,144,0.1)', border:'1px solid rgba(14,116,144,0.25)', borderRadius:6, padding:'14px 32px', marginBottom:56 }}>
              <span style={{ fontFamily:'var(--font-cond)', fontStyle:'italic', fontSize:'clamp(15px,2vw,20px)', color:'#67E8F9' }}>"Take what you need, give what you can."</span>
            </div>
          </div>
          <div style={{ display:'grid', gridTemplateColumns:'repeat(4,1fr)', gap:2, position:'relative' }}>
            ...
            {[
              ...
              { n:'02', title:'Distribution',       text:'With the help of volunteers and partners, each pantry ensures resources reach the right people at the right time—fairly and consistently.', emoji:'🚐', color:'#1565C0' },
              { n:'03', title:'Church Hubs',        text:'Churches serve as trusted community anchors—offering space, volunteers, and guidance to help each pantry operate smoothly.', emoji:'⛪', color:'#3B1FA3' },
              { n:'04', title:'Community Access',   text:'Each pantry ensures that resources reach the right people at the right time—fairly and consistently.', emoji:'🤝', color:'#7B0028' },
            ].map((step, i) => (
      ...
      <section style={{ padding:'100px 5%', background:'var(--bg-card2)' }}>
        <div style={{ maxWidth:1200, margin:'0 auto', display:'grid', gridTemplateColumns:'1fr 1fr', gap:80 }}>
          <div className="apple-left" data-delay="0">
            ...
            <p style={{ fontSize:15, color:'var(--text-muted)', lineHeight:1.9, fontWeight:300, marginBottom:36 }}>
      ...
      <section style={{ padding:'100px 5%', background:'var(--hero-grad)', position:'relative', overflow:'hidden' }}>
        ...
        <div style={{ maxWidth:1200, margin:'0 auto', display:'grid', gridTemplateColumns:'1fr 1fr', gap:60, position:'relative', zIndex:1 }}>
          <div>
            ...
            <p style={{ fontSize:15, color:'rgba(255,255,255,0.65)', lineHeight:1.8, marginBottom:24, fontWeight:300 }}>To keep the pantry fair, safe, and organized:</p>
          ...
          <div>
            <div style={{ background:'rgba(255,255,255,0.05)', border:'1px solid rgba(255,255,255,0.1)', borderRadius:8, padding:40, textAlign:'center' }}>
              <div style={{ fontFamily:'var(--font-cond)', fontSize:10, fontWeight:600, letterSpacing:'0.15em', textTransform:'uppercase', color:'rgba(103,232,249,0.5)', marginBottom:24 }}>Pantry Hours</div>
              ...
              <p style={{ fontSize:14, color:'rgba(255,255,255,0.55)', lineHeight:1.8, marginBottom:8 }}>Each PHPantry location operates on a consistent schedule to ensure reliability for the community.</p>
              <p style={{ fontSize:14, color:'rgba(255,255,255,0.55)', lineHeight:1.8, marginBottom:28 }}>Please check your local pantry for specific days and hours of operation.</p>
        ...
        <div style={{ maxWidth:1200, margin:'0 auto' }}>
          <div style={{ borderRadius:8, padding:'80px 60px', textAlign:'center', position:'relative', overflow:'hidden', background:'var(--hero-grad)', border:'1px solid rgba(255,255,255,0.07)' }}>
            ...
            <div style={{ position:'relative', zIndex:1 }}>
              ...
              <p style={{ fontSize:17, color:'rgba(255,255,255,0.7)', maxWidth:560, margin:'0 auto 14px', lineHeight:1.8, fontWeight:300 }}>
              ...
              <div style={{ display:'flex', gap:14, justifyContent:'center', flexWrap:'wrap' }}>
                <Link href="/get-involved" style={{ background:'white', color:'#061822', padding:'12px 32px', borderRadius:4, fontFamily:'var(--font-cond)', fontSize:13, fontWeight:600, letterSpacing:'0.15em', textTransform:'uppercase', textDecoration:'none', display:'inline-flex', alignItems:'center', gap:8, boxShadow:'0 4px 20px rgba(0,0,0,0.3)' }}>
                  <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"/></svg>
                  Volunteer Now
                </Link>
          ...
          <div style={{ display:'grid', gridTemplateColumns:'repeat(3,1fr)', gap:16, marginTop:40 }}>
            {[
              { emoji:'🙌', title:'Volunteer',       text:'Offer your time and heart. Help sort, distribute, and serve your community at a PHPantry hub near you.', color:'#0E7490' },
              { emoji:'💙', title:'Donate',          text:'Your donation—whether food, supplies, or financial support—directly feeds families across the Philippines. Every contribution matters.', color:'#3B1FA3' },
              { emoji:'📣', title:'Spread the Word', text:'Share our mission with your network. Every voice amplifies hope and invites more helpers to join the table.', color:'#7B0028' },
            ].map((card, i) => (
